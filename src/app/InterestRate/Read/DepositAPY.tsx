...
const CalculateDepositAPY = () => {
    ...
    const fetchAPY = async () => {
        ...
        try {
            const result = await publicClient.readContract({
                ...
                functionName: 'calculateDepositAPY',
    ...
    return (
        <div className="form-container">
            ...
            <button type='button' onClick={fetchAPY}>Get Deposit APY</button>
...
export default CalculateDepositAPY;
